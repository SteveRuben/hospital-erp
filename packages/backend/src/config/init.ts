...
export const initDB = async (): Promise<void> => {
  ...
  try {
    ...
    // Assurances + prises en charge + payment intents.
    await client.query(`
      DO $$
      BEGIN
    ...
    // exceptions datées (absence / présence ponctuelle). Idempotent.
    await client.query(`
